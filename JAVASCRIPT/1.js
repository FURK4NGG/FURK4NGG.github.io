...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const text = "I am an 18 year old high school student. Since 2020, I have mostly improved myself in back-end departments, particularly in Robotic Coding, Mobile Application Development, Website Creation, Cyber Security, and AI Prompt Engineering. I have also participated in MEB Robot Competitions and TUBITAK projects. In addition to these experiences, I have learned programming languages such as Python, Java, Kotlin, React Native, C++, C#, CSS, JavaScript, PHP, and SQL. Right now, I am working on projects related to Mobile Apps, AI and IoT.";
...
function runOnVisible() {
  ...
  const progressBar_10 = document.querySelector(".progress-value_10");
  ...
  progressBar_10.style.animation = "load_10 3s normal forwards";}
